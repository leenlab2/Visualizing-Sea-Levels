...
def temp_year_regression(year: float, temp: Dict[int, float]) -> float:
    """Return the predicted temperature of the given temp data set of the given year.
    """
...
def integration_approximation(year: int, temp: Dict[int, float]) -> float:
    """Return the riemann sum integrations of temperature minus t0 from 2012 to the given year of the
    given temp data set.
    """
    sum_so_far = 0
    n = 100
...
def finding_constant(temp: Dict[int, float]) -> float:
    """Return the proportionality constant between sea level and integration of temperature of
    temp data set"""
...
def sea_level_prediction(year: int, temp: Dict[int, float]) -> float:
    """Return the predicted sea level of in the given year of the temp data set"""
